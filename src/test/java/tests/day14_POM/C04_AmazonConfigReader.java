...
public class C04_AmazonConfigReader extends TestBase {
    ...
    public void test(){
        ...
        amazonPage.searchBoxElement.sendKeys(ConfigReader.getProperty("amazonArananKelime")+ Keys.ENTER);
        ...
        Assert.assertTrue(amazonPage.resultTextElement.getText().contains(ConfigReader.getProperty("amazonArananKelime")));
